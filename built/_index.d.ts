...
*/
export declare class PhantomJsCloudException extends ex.Exception {
}
/**
...
export declare class BrowserApi {
    ...
    _endpoint: net.RemoteHttpEndpoint<ioDatatypes.IUserRequest, ioDatatypes.IUserResponse>;
    /**
    * make a single browser request (PhantomJs call)
    * @param request
    * @param callback
    */
    requestSingle(request: ioDatatypes.IUserRequest | ioDatatypes.IPageRequest, callback?: (err?: axios.AxiosError, result?: ioDatatypes.IUserResponse) => void): Promise<ioDatatypes.IUserResponse>;
    /**
